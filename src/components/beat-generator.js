...
AFRAME.registerComponent('beat-generator', {
  //==== added by tx
  prevBeatPosition: null,  // Add this line to initialize the property
  ...
  */
  ...
  tick: function (time, delta) {
    ...
    //console.log('Generate beats ', notes[10])
    ...
    // Stage events.
    const events = this.beatData._events;
    //console.log('Generate beats ', events[10])
  ...
  generateBeat: function (noteInfo, index) {
    ...
    this.prevBeatPosition = noteInfo._time;
  },
